...
/*   Updated: 2025/07/07 16:50:34 by mbarhoun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	expand_var(t_token **t, t_ambg amb, t_list *env, bool f_quotes)
{
	t_exp	exp;
...
void	is_env(t_token **token, t_list *env, bool expander, bool ambg)
{
	t_ambg	amb;
